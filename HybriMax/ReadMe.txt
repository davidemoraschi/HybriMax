========================================================================
    ACTIVE TEMPLATE LIBRARY : HybriMax Project Overview
========================================================================

AppWizard has created this HybriMax project for you to use as the starting point for
...
HybriMax.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (HybriMax.h)
        GUID definitions                                (HybriMax_i.c)
        A type library                                  (HybriMax.tlb)
        Marshaling code                                 (HybriMax_p.c and dlldata.c)

HybriMax.h
    This file contains the C++ interface definitions and GUID declarations of the
    items defined in HybriMax.idl. It will be regenerated by MIDL during compilation.
...
StdAfx.h, StdAfx.cpp
    ...
    named HybriMax.pch and a precompiled types file named StdAfx.obj.
...
HybriMaxps.vcxproj
	...
	dlldata.c, HybriMax_i.c and HybriMax_p.c which are required
	to build the proxy/stub DLL.

HybriMaxps.vcxproj.filters
